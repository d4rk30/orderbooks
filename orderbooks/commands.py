...
from orderbooks.models import Good, ModelPrice, Expressage, Consignee, Cart, Order, User
...
def gendb():
    ...
    good = Good(
        ...
        description_images = faker.json(data_columns={'description_images':['image_url', 'image_url', 'image_url']}, num_rows=1)
    )
    db.session.add(good)
    #型号和价格
